...
const Anounce = () => {
  return (
    <div className="fixed z-40 top-0 inset-x-0 h-8 bg-myctaBg/90 hidden min-[500px]:grid place-content-center">
      <div className="md:text-sm text-xs text-white font-content font-normal">
